...
public class ServiceServiceLocator extends org.apache.axis.client.Service implements br.com.teste.kleber.webservice.ServiceService {
    ...
    private java.lang.String Service_address = "http://localhost:8080/WSSoap01/services/Service";
    ...
    public br.com.teste.kleber.webservice.Service getService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            br.com.teste.kleber.webservice.ServiceSoapBindingStub _stub = new br.com.teste.kleber.webservice.ServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (br.com.teste.kleber.webservice.Service.class.isAssignableFrom(serviceEndpointInterface)) {
                br.com.teste.kleber.webservice.ServiceSoapBindingStub _stub = new br.com.teste.kleber.webservice.ServiceSoapBindingStub(new java.net.URL(Service_address), this);
                _stub.setPortName(getServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://webservice.kleber.teste.com.br", "ServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://webservice.kleber.teste.com.br", "Service"));
        }
